...
if ($entradaOK) {// si el valor es true entra
    ...
    $oUsuario = UsuarioPDO::altaUsuario($usuario, $descripcion, $password); //llamamos a la funcion alta usuario de la case UsuarioPDO y le pasaremos los valores de $usuario,$descripción y $password
